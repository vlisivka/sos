...
<details><summary>Стратегія</summary>

Стратегія — це короткий опис шляху від початкової точки і до бачення
майбутнього, використовуючи ті ресурси і можливості, які доступні нам.

Завдання стратегії — показати, як можна досягнути мети використовуючи
ключові точки, які примножують зусилля і створюють стратегічну
перевагу.

Загальну стратегію розвитку стартапу у великий бізнес має розробляти CEO.
